...
function Header() {
  ...
  return (
    <header id="header" className="flex items-center justify-between h-20 border-b bg-gradient-to-r from-lime-400 to-green-400 transition-transform duration-300 transform">
